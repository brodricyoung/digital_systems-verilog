...
HD_PWD='C:/Users/young/OneDrive/Documents/- Hardware Labs/digital_systems-verilog/ecen340/Lab7_State_Machines/morse_code_decoder/morse_code_decoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log morse_code_decoder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source morse_code_decoder.tcl -notrace
