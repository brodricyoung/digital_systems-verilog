...
HD_PWD='C:/Users/young/OneDrive/Documents/- Hardware Labs/digital_systems-verilog/ecen340/Lab7_State_Machines/morse_code_decoder/morse_code_decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log morse_code_decoder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source morse_code_decoder.tcl
