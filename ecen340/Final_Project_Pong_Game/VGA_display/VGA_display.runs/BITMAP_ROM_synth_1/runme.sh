...
HD_PWD='C:/Users/young/OneDrive/Documents/- Hardware Labs/digital_systems-verilog/ecen340/Final_Project_Pong_Game/VGA_display/VGA_display.runs/BITMAP_ROM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BITMAP_ROM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BITMAP_ROM.tcl
